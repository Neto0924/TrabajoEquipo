								...
								<div class="row">
									<div class="col-xs-12  col-sm-12 col-md-6 col-lg-6">
										<div class="form-group">
											<label for="idPersona">Nombre del Paciente:</label>
									...
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
										<div class="form-group">
											<label for="idSede">Medicamento:</label>
